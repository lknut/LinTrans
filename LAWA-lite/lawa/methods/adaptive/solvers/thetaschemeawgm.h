...
struct ThetaSchemeAWGM {
	...
	//LK solves as above but stores the next to last solution (to be able to calc sensitivities (Theta)
	void
	solveWithNextToLast(Coefficients<Lexicographical,T,Index> &u,Coefficients<Lexicographical,T,Index> &u_nextToLast,
