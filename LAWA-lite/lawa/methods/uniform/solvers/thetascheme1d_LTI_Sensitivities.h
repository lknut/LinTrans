#ifndef LAWA_METHODS_UNIFORM_SOLVERS_THETASCHEME1D_LTI_SENSITIVITIES_H
#define LAWA_METHODS_UNIFORM_SOLVERS_THETASCHEME1D_LTI_SENSITIVITIES_H 1
 ...
 *      It assumes time-constant bilinear forms A and tildeA, so that the system matrices
 *      are only assembled once. TildeA is a derivative of A with respect to a model Parameter
 *      
 *
...
class ThetaScheme1D_LTI_Sensitivities
{
	...
	//LK, this is needed to calculate sensitivities
        // flens::DenseVector<flens::Array<T> > 
        // solve(T time_old, T time_new, flens::DenseVector<flens::Array<T> > u_init, 
        //       flens::DenseVector<flens::Array<T> > f, int level);
    ...
    private:
        class Operator_LHSMatrix{
            private:
			ThetaScheme1D_LTI_Sensitivities<T, Basis, BilinearForm, tildeBilinearForm, RHSIntegral, L2ScalarProduct>* scheme;
                const BilinearForm& a;
                T time_old;
                T time_new;
            
            public:                
			Operator_LHSMatrix(ThetaScheme1D_LTI_Sensitivities<T, Basis, BilinearForm, tildeBilinearForm, RHSIntegral,
        ...
        class Operator_RHSMatrix{
            private:
			const ThetaScheme1D_LTI_Sensitivities<T, Basis, BilinearForm, tildeBilinearForm, RHSIntegral,
	    ...
	    //LK, new to calculate sensitivities
	    flens::SparseGeMatrix<flens::CRS<T,flens::CRS_General> > tildeA;

	//LK: BilinearForm of tildeA
	    const tildeBilinearForm& tildea;
};
      
} // namespace lawa

#include <lawa/methods/uniform/solvers/thetascheme1d_LTI_Sensitivities.tcc>

#endif // LAWA_METHODS_UNIFORM_SOLVERS_THETASCHEME1D_LTI_SENSITIVITIES_H
