...
/////////////////////////////////////////////////////////////////////////////////////
// LK: This is a implementation for the CGMYeLineaerTransformation2DJump2D process //
/////////////////////////////////////////////////////////////////////////////////////
	


template <typename Basis2D>
struct FinanceOperator2D<CGMYeLinearTransformation2DJump2D, Basis2D>
{
    typedef typename Basis2D::T T;
    ...
    FinanceOperator2D(const Basis2D& _basis,
                      const ProcessParameters2D<T,CGMYeLinearTransformation2DJump2D> &_processparameters,
                      T _R1_1=0., T _R2_1=1., T _R1_2=0., T _R2_2=1., int order=10,
                      int _internal_compression_level1=-1, int _internal_compression_level2=-1);
    ...
    const Basis2D                                       &basis;
    const ProcessParameters2D<T,CGMYeLinearTransformation2DJump2D>  &processparameters;
    T                                                   R1_1, R2_1, R1_2, R2_2;
    int                                                 internal_compression_level1;
    int                                                 internal_compression_level2;
