...
#ifndef APPLICATIONS_FINANCE_OPERATORS_SENSITIVITIES_CGMYEOPERATOR1D_M_H
#define APPLICATIONS_FINANCE_OPERATORS_SENSITIVITIES_CGMYEOPERATOR1D_M_H 1
...
//LK, new
#include <applications/finance/kernels/sensitivities/cgmykernel_M.h>

namespace lawa {


//LK, operator \tilde{A} of HilberSchwabWinter wrt M	
template <typename T, typename Basis1D>
struct FinanceOperator1D<T, CGMYeSensitivitiesM, Basis1D>
{
    #ifdef TRONE
    ...
    Kernel<T,CGMYeSensitivitiesM>                     kernel;
	//LK tmp
    ...
    SingularIntegral<Kernel<T,CGMYeSensitivitiesM>,Basis1D,Basis1D> singularIntegral;
...
#include <applications/finance/operators/sensitivities/cgmyeoperator1d_M.tcc>

#endif  // APPLICATIONS_FINANCE_OPERATORS_CGMYEOPERATOR1D_M_H
