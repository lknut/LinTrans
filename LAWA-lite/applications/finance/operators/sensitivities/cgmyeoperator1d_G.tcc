...
FinanceOperator1D<T, CGMYeSensitivitiesG, Basis1D>::FinanceOperator1D
...
template <typename T, typename Basis1D>
void
FinanceOperator1D<T, CGMYeSensitivitiesG, Basis1D>::setCompressionLevel(int _internal_compression_level)
{
...
template <typename T, typename Basis1D>
T
FinanceOperator1D<T, CGMYeSensitivitiesG, Basis1D>::operator()(XType xtype1, int j1, int k1,
...
template <typename T, typename Basis1D>
T
FinanceOperator1D<T, CGMYeSensitivitiesG, Basis1D>::operator()(const Index1D &row_index,
