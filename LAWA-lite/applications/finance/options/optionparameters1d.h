...
struct OptionParameters1D<T,Put> {
	...
	//LK: processparameters need to be known for the payoff to implement the Tops-Model
    OptionParameters1D(T _strike, T _maturity, bool _earlyExercise,
					   bool _lineartransformation=false,
					   ProcessParameters1D<T,CGMYe> _processparameters=ProcessParameters1D<T,CGMYe>());
