...
//LK: to be able to use the linear transformation
...
struct OptionParameters2D<T,BasketPut> {
	...
	T weight1, weight2;
	bool earlyExercise;
	// LK: this is necessary to change the payoff function if a linear transformation is involved
	ProcessParameters2D<T, CGMYeLinearTransformation2DJump2D> processparameters;
	bool lineartransformation;
};
