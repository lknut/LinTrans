...
template <typename T>
ProcessParameters1D<T,CGMYe>::ProcessParameters1D()
	: r(0.0), k_C(0.0), k_G(0.0), k_M(0.0), k_Y(0.0), sigma(0.0), lineartransformation(false)
{

}
	
template <typename T>
ProcessParameters1D<T,CGMYe>::ProcessParameters1D(T _r, T _k_C, T _k_G, T _k_M, T _k_Y, T _sigma, bool _lineartransformation)
	: r(_r), k_C(_k_C), k_G(_k_G), k_M(_k_M), k_Y(_k_Y), sigma(_sigma), lineartransformation(_lineartransformation)
{
