...
#ifndef APPLICATIONS_FINANCE_KERNELS_SENSITIVITIES_CGMYKERNEL_G_H
#define APPLICATIONS_FINANCE_KERNELS_SENSITIVITIES_CGMYKERNEL_G_H 1
...
//LK, kernel implementation of $\tilde{A}$ of HilberSchwabWinter2008 wrt model parameter G
template <typename T>
struct Kernel<T,CGMYeSensitivitiesG> 
{
...
#include <applications/finance/kernels/sensitivities/cgmykernel_G.tcc>

#endif  // APPLICATIONS_FINANCE_KERNELS_SENSITIVITIES_CGMYKERNEL_G_H
