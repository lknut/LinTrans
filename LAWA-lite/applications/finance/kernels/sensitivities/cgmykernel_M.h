...
#ifndef APPLICATIONS_FINANCE_KERNELS_SENSITIVITIES_CGMYKERNEL_M_H
#define APPLICATIONS_FINANCE_KERNELS_SENSITIVITIES_CGMYKERNEL_M_H 1
...
//LK, kernel implementation of $\tilde{A}$ of HilberSchwabWinter2008 wrt model parameter M
template <typename T>
struct Kernel<T,CGMYeSensitivitiesM> 
{
...
#include <applications/finance/kernels/sensitivities/cgmykernel_M.tcc>

#endif  // APPLICATIONS_FINANCE_KERNELS_SENSITIVITIES_CGMYKERNEL_M_H
